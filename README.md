...
- 🕹️ **卡带物理插拔体验**：支持从左侧卡带袋拾取卡带，平滑滑入主机插槽，伴随微动与机械咬合音效；支持一键弹出与换卡。
...
- 📂 **支持拖拽载入 ROM**：内置精选 3D 演示游戏，亦可将任意本地 `.gba` 游戏文件直接拖入页面即插即玩。

---

## 按键操作说明

| GBA 按键 | 键盘对应按键 | 3D 实体交互 |
|---|---|---|
| **十字方向键 (D-Pad)** | `↑` `↓` `←` `→` 方向键 | 点击主机对应方向键微动下沉 |
| **A 键 / B 键** | `Z` / `X` | 点击右侧对应按键下沉 |
| **L 键 / R 键** | `Q` / `E` | 顶部肩键 |
| **Select / Start** | `V` / `Enter` | 橡胶椭圆键 |
| **视角旋转 / 缩放** | 鼠标左键拖拽 / 滚轮 | 鼠标右键平移视角 |
